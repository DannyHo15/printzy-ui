        ...
        <div className="flex min-h-screen place-items-center justify-center">
          <div className="max-w-3xl mx-auto pb-10 w-10/12 md:w-auto">
            <div
              // initial={{ opacity: 0 }}
              // animate={{ opacity: 1 }}
              className="rounded-2xl overflow-hidden bg-white p-5 flex place-items-center justify-center"
            >
              <div className="flex flex-col place-items-center text-center text-cusblack">
                ...
                <button
                  ...
                  className="py-2 px-4 text-xs hover:bg-white hover:text-secondary duration-200 hover:border-secondary border rounded-lg my-2 bg-secondary text-white"
                >
                  See My Orders
                </button>
              </div>
