...
const DetailProductReviews = () => {
  const reviewsData = [
    { rating: 5, percentage: "100%", count: 15 },
    { rating: 4, percentage: "00%", count: 0 },
      ...
      <div className="gap-3 pb-6">
        ...
        <div className="mt-2 min-w-0 flex-1 space-y-4">
          <p className="text-sm font-normal text-gray-400">
            My favorite artist! Everything she does is amazing!
          </p>
        </div>
        ...
        <button className="w-fit mt-4 text-sm rounded-3xl ring-1 ring-secondary text-secondary py-2 px-4 hover:bg-secondary hover:text-white disabled:cursor-not-allowed disabled:bg-pink-200 disabled:ring-0 disabled:text-white disabled:ring-none">
          + Write your review
        </button>
      </div>
    </div>
