...
const Navbar = () => {
  ...
  return (
    <div className="h-24 px-4 fixed w-full bg-background shadow-sm z-[99999]">
      {/* MOBILE */}
      ...
      <div className="hidden md:flex items-start justify-between gap-8 h-full w-[90%] mx-auto m-5">
        {/* LEFT (Logo) */}
        <div className="flex items-center justify-start w-1/2 xl:w-2/12">
          <Link
            href="/"
        ...
        <div className="w-1/2 xl:w-6/12 flex items-start justify-center h-full">
